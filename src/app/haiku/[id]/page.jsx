...
'use client'; // nécessaire pour l'interaction du bouton/modal
...
export default async function HaikuPage({ params }) {
  ...
  return (
    <HaikuClientView haiku={haiku} comments={comments} />
  );
}

// Composant client pour la gestion interactive (bouton + modal)
function HaikuClientView({ haiku, comments }) {
  ...
  return (
    <main className="p-5 max-w-xl mx-auto">
      ...
      {/* Affichage du formulaire uniquement si showForm=true */}
      {showForm && (
